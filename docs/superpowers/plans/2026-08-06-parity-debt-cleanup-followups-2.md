# Parity-cleanup follow-ups (batch 2) — implementation plan (iteration 2)

Epic: catboost-8z4. Base branch: phase-0 (c102350, parity-debt-cleanup batch merge).

## Global Constraints

- **Mechanism:** direct-fix tickets, follow-ups filed during/after the parity-debt-cleanup batch's execution/review. No new R public API surface, no new native entry points.
