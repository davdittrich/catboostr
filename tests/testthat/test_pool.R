...
test_that("pool: load_pool from file multitarget", {
  train_path <- system.file("extdata", "multitarget.train", package = "catboostr")
  cd_path <- system.file("extdata", "multitarget.cd", package = "catboostr")
...
test_that("pool: nan", {
  data_path <- system.file("extdata", "float_with_nan.tsv", package = "catboostr")
  column_description_path <- system.file("extdata", "float_with_nan.cd", package = "catboostr")
